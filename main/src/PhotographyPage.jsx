...
const PhotographyPage = () => {
        ...
        imageDir.keys().forEach((key) => {
            ...
            images.push(
                <ImageListItem key={key} onClick={handleImageClick}>
                    <img
                        src={require(`./images/photography/my_gallery/${key}`)}
                        alt={alt_text}
                    />
                </ImageListItem>
            );
    ...
    return (
        <Container maxWidth="md" style={flexCenter}>
            {selectedImg !== null ? (
                <>
                    <ImageListItem key={altText}>
                        ...
                        <img src={selectedImg} alt={altText} loading="lazy" />
                        <ImageListItemBar
                            title={altText}
                            actionIcon={
                                <IconButton
